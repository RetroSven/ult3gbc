...
#include "music2/legacy.c"
#include "music2/victory.c"
#include "music2/deadsong.c"
...
UBYTE oooo1, oooo2, oooo3,vvvv1,vvvv2,vvvv3 ;
UBYTE max_att3_step ;
UBYTE curr_att3 ;
...
void voice0(UBYTE thehash)
{
	...
	if ( (thehash & 16) != 0 )
	{
		if ( ( thehash & 32 ) != 0 )
		{
			...
			{
				gb_freq -= (12*oooo1);
				freqLOW = frequencies4[gb_freq] & 0x00FF ;
				freqHI = (frequencies4[gb_freq] & 0x0700) >> 8 ;
			}
			else
			{
				freqLOW = 0 ;
...
void voice2(UBYTE thehash)
{
	...
	if ( (thehash & 1) != 0 )
	{
		if ( ( thehash & 2 ) != 0 )
		{
			...
			w3_ram = u3wander_RAM4+0x100UL ;

			if ( gb_freq >= 12*oooo3 )
			{
				gb_freq -= (12*oooo3);
				freqLOW3 = frequencies4[gb_freq] & 0x00FF ;
				freqHI3 = (frequencies4[gb_freq] & 0x0700) >> 8 ;
			}
			else
			{
				freqLOW3 = 0 ;
...
void init_music()
{
	...
	memcpy((unsigned char*)0xFF30,u3wander_RAM4+0x100UL, 0x10L) ;
	w3_ram = u3wander_RAM4+0x100UL ;
	...
	switch ( musicnum )
	{
		case 0: 
			{
				musicdat_start = legacymusic ;
				datasong_ptr = legacymusic ;
				oooo1 = 4 ;
				oooo2 = 4 ;
				oooo3 = 4 ;
				max_att3_step = 3 ;
		...
		case 1: 
			{
				musicdat_start = victorymusic ;
				datasong_ptr = victorymusic ;
				oooo1 = 4 ;
				oooo2 = 4 ;
				oooo3 = 4 ;
				max_att3_step = 3 ;
		...
		case 2: 
			{
				musicdat_start = deadsong;
				datasong_ptr = deadsong;
				oooo1 = 4 ;
				oooo2 = 5 ;
				oooo3 = 5 ;
				max_att3_step = 3 ;
