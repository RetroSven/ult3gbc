echo Compiling for Analogue Pocket
echo.
echo.

echo .ANALOGUE_POCKET = 1 > ..\..\lib\pocket.s

echo #ifndef _POCKET_H >  ..\..\include\gb\pocket.h
echo #define _POCKET_H >>  ..\..\include\gb\pocket.h
echo #define ANALOGUE_POCKET 1 >>  ..\..\include\gb\pocket.h
echo #endif >>  ..\..\include\gb\pocket.h
echo. >> ..\..\include\gb\pocket.h
...
echo.
echo.
echo Finished compiling for Analog Pocket